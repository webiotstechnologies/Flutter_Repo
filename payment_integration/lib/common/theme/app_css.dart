import 'package:payment_integration/common/extension/text_style_extensions.dart';
...
class AppCss {
  ...
  static TextStyle get montserratExtraBold14 => montserrat.extraThickBold.size(FontSizes.f14);
  static TextStyle get montserratExtraBold12 => montserrat.extraThickBold.size(FontSizes.f12);
  ...
  static TextStyle get montserratSemiBold15=> montserrat.semiBold.size(FontSizes.f14);
